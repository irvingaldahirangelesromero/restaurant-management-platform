...
export default function InventoryPage() {
  ...
  return (
    <div className="flex min-h-screen">
      <AdminSidebar activePage="inventory" user={{ name: "Admin" }} />
      <main className="flex-1 ml-[260px] p-8 md:p-10 min-w-0 max-w-[1400px] mx-auto animate-in fade-in duration-700">
